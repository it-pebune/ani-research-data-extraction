...
class Associate(TableInDocument):
    ...
    def create_from_row(self, row):
        ...
        self.no_of_shares = self.get_field_from_row(2, row)
        self.value_of_shares = self.get_field_from_row(3, row)
    ...
    def create_from_cells(self, row):
        ...
        self.no_of_shares = self.get_field_from_cells(2, cell_map)
        self.value_of_shares = self.get_field_from_cells(3, cell_map)
